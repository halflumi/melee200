AID = {
    ...
    RAIN_OF_HELLFIRE = "AA36",
    RAIN_OF_HELLFIRE_IMPL = "AA37",
    RAIN_OF_HELLFIRE_SOUND = "AA38",
}
...
BID = {
    ...
    FLOATING_CHAOS = "EA30",
    RAIN_OF_HELLFIRE_DOT = "EA31",
    RAIN_OF_HELLFIRE_EFFECT = "EA32",
    RAIN_OF_HELLFIRE_SOUND_EFFECT = "EA33",
}
